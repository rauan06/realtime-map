...
/*
Package producerrpb is a reverse proxy.
...
func local_request_ProducerService_SendLocation_0(ctx context.Context, marshaler runtime.Marshaler, server ProducerServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq OBUData
		metadata runtime.ServerMetadata
	)
...
func RegisterProducerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ProducerServiceServer) error {
	mux.Handle(http.MethodPost, pattern_ProducerService_SendLocation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/location.ProducerService/SendLocation", runtime.WithHTTPPathPattern("/v1/location"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ProducerService_SendLocation_0(annotatedContext, inboundMarshaler, server, req, pathParams)
