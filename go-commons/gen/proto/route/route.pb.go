...
const file_proto_route_route_proto_rawDesc = "" +
	...
	"\bDeviceID\x12\x1b\n" +
	"\tdevice_id\x18\x01 \x01(\fR\bdeviceId2\x8c\x02\n" +
	"\x05Route\x12V\n" +
	"\fStartSession\x12\x12.location.DeviceID\x1a\x16.google.protobuf.Empty\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/route/start\x12R\n" +
	"\n" +
...
var file_proto_route_route_proto_depIdxs = []int32{
	...
	3, // 4: location.Route.StartSession:output_type -> google.protobuf.Empty
