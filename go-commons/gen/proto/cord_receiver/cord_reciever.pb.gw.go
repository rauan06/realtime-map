...
func request_LocationService_SendLocation_0(ctx context.Context, marshaler runtime.Marshaler, client LocationServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq OBUData
...
func local_request_LocationService_SendLocation_0(ctx context.Context, marshaler runtime.Marshaler, server LocationServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq OBUData
		metadata runtime.ServerMetadata
	)
...
func RegisterLocationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server LocationServiceServer) error {
	mux.Handle(http.MethodPost, pattern_LocationService_SendLocation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/location.LocationService/SendLocation", runtime.WithHTTPPathPattern("/v1/location"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_LocationService_SendLocation_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_LocationService_SendLocation_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
var (
	forward_LocationService_SendLocation_0 = runtime.ForwardResponseMessage
)
